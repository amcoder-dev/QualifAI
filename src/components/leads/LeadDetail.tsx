              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span>{Math.round((lead.analysis.sentiment.positive - lead.analysis.sentiment.negative) * 0.8)}/40</span>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`px-2 py-1 rounded-full text-sm ${
                      lead.analysis.score >= 80 ? 'bg-green-100 text-green-800' : 
                      lead.analysis.score >= 60 ? 'bg-yellow-100 text-yellow-800' : 
                      'bg-red-100 text-red-800'
                    }`}>
                      {lead.analysis.score >= 80 ? 'High Priority' : 
                      lead.analysis.score >= 60 ? 'Medium Priority' : 
                      'Low Priority'}
                    </span>
                  </div>
                </div>
